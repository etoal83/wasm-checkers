fetch('./func_test.wasm').then(res =>
  ...
  console.log('Uncrowned white is white?', instance.exports.isWhite(instance.exports.withoutCrown(crowned_white)));
  console.log('Uncrowned black is black?', instance.exports.isBlack(instance.exports.withoutCrown(crowned_black)));
